...
This is a visual studio code syntax highlighter and auto completer for the newserv quest script assembler, for phantasy star online. Auto completion for opcodes is only about 1/3 complete but all opcodes do get highlighted. Not sure when I'll get around to finishing the auto completion, I'm busy working on quests at the moment. If you have ideas on how to improve this or just want to help, contributions are greatly appreciated.
...
2. Extract the files from nqasm.zip

3. In visual studio code click the extensions tab.

   <img width="43" height="291" alt="image" src="https://github.com/user-attachments/assets/3f75ad57-c011-402f-a794-741080c7784b" />
   
4. Click the 3 dots above the extensions search bar.
  <img width="339" height="83" alt="image" src="https://github.com/user-attachments/assets/7ef9a374-3f0d-40d1-8328-044dde2962e6" />

5. Click install from vsix and select the "nqasm-x.x.x.vsix" that you extracted from the zip folder.

6. (Optional) Click the gear on the nqasm extension, then click "set theme" to use the theme I made for nqasm.
...
1. In visual studio code open NqasmScriptTemplate.txt that was in the nqasm.zip folder

2. At the very bottom of visual studio code click where it says "{} Plain Text"
   
   <img width="173" height="36" alt="image" src="https://github.com/user-attachments/assets/b725366d-3331-4b75-a1d1-c7fbc656bfc5" />

3. Select nqasm from the list of languages
   
4. Once you're done editing your quest script, open a command prompt and run the following command: <newserv.exe location> assemble-quest-script --bb <questscript.txt location> (replace --bb with the pso version you're making the quest for)

5. Your assembled quest script will be in the same folder as your non-assembled questscript.txt
